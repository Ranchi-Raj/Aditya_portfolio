      ...
      <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-gray-300">NoSQL Databases ( MongoDB and Appwrite)</span>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-gray-300">Python and its Libraries (Numpy, Pandas etc.)</span>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-purple-400">Professional Skills</h3>
        ...
        <section id="resume" className="py-20">
          <div className="container mx-auto px-4">
              ...
              <div className="md:w-1/2">
                ...
                <div className="space-y-8">
                  <div className="relative pl-8 border-l-2 border-purple-500/30 pb-8">
                    ...
                    <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                      <h4 className="text-xl font-semibold mb-1">Full Stack Freelancer Developer</h4>
                      <p className="text-purple-400 mb-2">Zuno Gaming. | Dec 2024 - Jan 2025</p>
                      <p className="text-gray-400">
                        Made the working website for the client from scratch. It was a full stack project with a separate admin panel too. It consisted of dedicated server, simultaneous user interactions, having complete control of history and many more. 
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-8 border-l-2 border-purple-500/30 pb-8">
                    ...
                    <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                      ...
                      <p className="text-purple-400 mb-2">Webnd Society (IIT BBS) | 2024 - 2025</p>
                      <p className="text-gray-400">
                        Created and handled the updates of many websites like Gymkhana website(The Php code one), Code relay website, Pravaah Website and other small projects. 
                      </p>
                    </div>
                  </div>
                  ...
                  {/* <div className="relative pl-8 border-l-2 border-purple-500/30">
                    ...
                    <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                      ...
                      <p className="text-purple-400 mb-2">DigitalCraft Agency | 2016 - 2018</p>
                      <p className="text-gray-400">
                        Created interactive user interfaces, collaborated with designers to implement pixel-perfect
                        designs, and optimized website performance.
                      </p>
                    </div>
                  </div> */}
                </div>
              ...
              <div className="md:w-1/2">
                ...
                <div className="space-y-8">
                  <div className="relative pl-8 border-l-2 border-purple-500/30 pb-8">
                    <div className="absolute w-4 h-4 bg-purple-500 rounded-full -left-[9px] top-0"></div>
                    <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                      <h4 className="text-xl font-semibold mb-1">Bachelor of Technology </h4>
                      <p className="text-purple-400 mb-2">IIT Bhubaneshwar | 2023 - 2027</p>
                      <p className="text-gray-400">
                        Currently pursuing a B.Tech course with a descent CGPA 8.57. 
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-8 border-l-2 border-purple-500/30 pb-8">
                    <div className="absolute w-4 h-4 bg-purple-500 rounded-full -left-[9px] top-0"></div>
                    <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                      <h4 className="text-xl font-semibold mb-1">Intermediate ( 12th )</h4>
                      <p className="text-purple-400 mb-2"> Vivekanda Vidya Mandir | 2023</p>
                      <p className="text-gray-400">
                        Completed my intermediate with 94.4% in 2023.
                      </p>
                    </div>
                  </div>
                    ...
                    {/* <div className="relative pl-8 border-l-2 border-purple-500/30">
                      <div className="absolute w-4 h-4 bg-purple-500 rounded-full -left-[9px] top-0"></div>
                      <div className="bg-[#1a1a2e] p-6 rounded-lg shadow-lg">
                        <h4 className="text-xl font-semibold mb-1">Professional Scrum Master</h4>
                        <p className="text-purple-400 mb-2">Scrum.org | 2020</p>
                        <p className="text-gray-400">
                          Certified in facilitating Scrum processes and helping teams deliver high-value products.
                        </p>
                      </div>
                    </div> */}
                </div>
            ...
            <div className="text-center mt-12">
              <a href="https://drive.google.com/file/d/1_ByazByVXgHf6otgP27WliArSK_y3G3H/view?usp=drivesdk" target="_blank">
